...
name: upskill
description: >
  Use when the user wants to identify skill gaps, generate a learning plan, or analyze what to learn.
  Triggers on: upskill, skill gaps, learning plan, what should I learn, /upskill.
---
