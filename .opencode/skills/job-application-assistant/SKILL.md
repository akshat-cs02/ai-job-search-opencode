...
description: >
  Use when the user asks about job applications, evaluating job postings, tailoring CVs, writing cover letters,
  or interview prep. Triggers on: job posting, apply, CV, cover letter, resume, interview, career, ansøgning, stilling.
---
