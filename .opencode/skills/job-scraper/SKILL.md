...
name: job-scraper
description: >
  Use when the user wants to find new jobs, scrape job portals, or search for positions.
  Triggers on: find jobs, search jobs, scrape, new positions, job search, /scrape.
---
